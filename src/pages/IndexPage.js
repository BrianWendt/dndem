    ...
    render() {
        return (
                ...
                <DefaultTemplate>
                    ...
                    <Alert variant="warning"><span className="text-danger">&#10071; Notice:</span> This website uses browser cookies to store Encounter infomation. Using this website means that you accept this.</Alert>
